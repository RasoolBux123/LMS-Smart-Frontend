...
import { quizzesApi, type Coursework } from "@/lib/api/coursework";
    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="This quiz may have already been deleted."
        />
      ) : (
        <>
          <div>
          ...
          <QuizForm mode="edit" quizId={id} defaultValues={quiz} />
        </>
      )}
    </div>
  );
